# Generated by Django 3.0.3 on 2020-06-23 14:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='default/64x64.png', upload_to='uploads/%Y/%m/%d/', verbose_name="User's Avatar")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_like', models.SmallIntegerField(default=0, validators=[app.models.validate_rate])),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Question')),
